...
#[case([DBG_SYS_TIME_GE, DBG_SYNC_DIFF, DBG_NONE, DBG_NONE], [0x03, 0, 0, 0], [Some(GPIOOutputType::SysTimeGe(DcSysTime::ZERO + 3 * std::time::Duration::from_micros(25))), Some(GPIOOutputType::SyncDiff), None, None])]
