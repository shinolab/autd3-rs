...
pub const ADDR_MOD_FREQ_DIV0_0: usize = 0x23;
// pub const ADDR_MOD_FREQ_DIV0_1: usize = 0x24;
pub const ADDR_MOD_CYCLE1: usize = 0x25;
pub const ADDR_MOD_FREQ_DIV1_0: usize = 0x26;
// pub const ADDR_MOD_FREQ_DIV1_1: usize = 0x27;
pub const ADDR_MOD_REP0_0: usize = 0x28;
// pub const ADDR_MOD_REP0_1: usize = 0x29;
pub const ADDR_MOD_REP1_0: usize = 0x2A;
// pub const ADDR_MOD_REP1_1: usize = 0x2B;
pub const ADDR_MOD_TRANSITION_MODE: usize = 0x2C;
pub const ADDR_MOD_TRANSITION_VALUE_0: usize = 0x2D;
// pub const ADDR_MOD_TRANSITION_VALUE_1: usize = 0x2E;
// pub const ADDR_MOD_TRANSITION_VALUE_2: usize = 0x2F;
// pub const ADDR_MOD_TRANSITION_VALUE_3: usize = 0x30;
...
pub const ADDR_STM_CYCLE0: usize = 0x54;
pub const ADDR_STM_FREQ_DIV0_0: usize = 0x55;
// pub const ADDR_STM_FREQ_DIV0_1: usize = 0x56;
pub const ADDR_STM_CYCLE1: usize = 0x57;
pub const ADDR_STM_FREQ_DIV1_0: usize = 0x58;
// pub const ADDR_STM_FREQ_DIV1_1: usize = 0x59;
pub const ADDR_STM_REP0_0: usize = 0x5A;
// pub const ADDR_STM_REP0_1: usize = 0x5B;
pub const ADDR_STM_REP1_0: usize = 0x5C;
