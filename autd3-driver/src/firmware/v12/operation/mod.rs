...
macro_rules! impl_v12_op {
    ($ty:ty) => {
        impl<'dev> OperationGenerator<'dev> for  $ty {
            type O1 = <Self as crate::firmware::v11::operation::OperationGenerator<'dev>>::O1;
            type O2 = <Self as crate::firmware::v11::operation::OperationGenerator<'dev>>::O2;
    ...
    ($($generics:tt),+; $ty:ty) => {
           ...
           where
               $ty: crate::firmware::v11::operation::OperationGenerator<'dev>,
           {
               type O1 = <Self as crate::firmware::v11::operation::OperationGenerator<'dev>>::O1;
               type O2 = <Self as crate::firmware::v11::operation::OperationGenerator<'dev>>::O2;
