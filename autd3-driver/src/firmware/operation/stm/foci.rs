...
use crate::{
    ...
    firmware::{
        fpga::{
            FOCI_STM_BUF_SIZE_MAX, FOCI_STM_FOCI_NUM_MAX, LoopBehavior, STM_BUF_SIZE_MIN, STMFocus,
            SamplingConfig, Segment, TRANSITION_MODE_NONE, TransitionMode,
        },
...
mod tests {
    ...
    use crate::{
        ...
        firmware::{
            ...
            operation::{ControlPoint, tests::create_device},
        },
        geometry::Point3,
    };
