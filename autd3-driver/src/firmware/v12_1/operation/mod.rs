...
macro_rules! impl_v12_1_op {
    ($ty:ty) => {
        impl OperationGenerator for $ty {
            type O1 = <Self as crate::firmware::v12::operation::OperationGenerator>::O1;
            type O2 = <Self as crate::firmware::v12::operation::OperationGenerator>::O2;
    ...
    ($($generics:tt),+; $ty:ty) => {
           ...
           where
               $ty: crate::firmware::v12::operation::OperationGenerator,
           {
               type O1 = <Self as crate::firmware::v12::operation::OperationGenerator>::O1;
               type O2 = <Self as crate::firmware::v12::operation::OperationGenerator>::O2;
...
impl_v12_1_op!(G; autd3_core::gain::GainOperationGenerator<G>);
...
impl_v12_1_op!(F; crate::datagram::PulseWidthEncoder<autd3_core::datagram::PulseWidth<{ super::fpga::ULTRASOUND_PERIOD_COUNT_BITS }, u16>, F>);
impl_v12_1_op!(F; crate::datagram::ReadsFPGAState<F>);
impl_v12_1_op!(F; crate::datagram::PhaseCorrection<F>);
impl_v12_1_op!(F; crate::datagram::EmulateGPIOIn<F>);
impl_v12_1_op!(T; crate::datagram::GainSTMOperationGenerator<T>);
