...
use crate::{
    ...
    firmware::{
        driver::{Driver, FPGAState, Sender, TimerStrategy},
...
impl FPGAState for super::fpga::FPGAState {
    fn from_rx(rx: &autd3_core::link::RxMessage) -> Option<Self> {
        super::fpga::FPGAState::from_rx(rx)
    }
}
