...
pub struct PulseWidthEncoderOp<
    F: Fn(EmitIntensity) -> PulseWidth<ULTRASOUND_PERIOD_COUNT_BITS, u16>,
> {
    is_done: bool,
    f: F,
}

impl<F: Fn(EmitIntensity) -> PulseWidth<ULTRASOUND_PERIOD_COUNT_BITS, u16>> PulseWidthEncoderOp<F> {
