...
use crate::{datagram::FetchFirmwareInfoOpGenerator, error::AUTDDriverError, geometry::Device};

enum Inner {
    V10(crate::firmware::v10::operation::FirmInfoOp),
    V11(crate::firmware::v11::operation::FirmInfoOp),
    V12(crate::firmware::v12::operation::FirmInfoOp),
}
