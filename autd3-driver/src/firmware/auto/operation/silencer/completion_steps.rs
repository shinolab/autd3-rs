...
use crate::{datagram::FixedCompletionSteps, error::AUTDDriverError, geometry::Device};

enum Inner {
    V10(crate::firmware::v10::operation::SilencerFixedCompletionStepsOp),
    V11(crate::firmware::v11::operation::SilencerFixedCompletionStepsOp),
    V12(crate::firmware::v12::operation::SilencerFixedCompletionStepsOp),
}
