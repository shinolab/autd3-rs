...
use crate::{datagram::Clear, error::AUTDDriverError, geometry::Device};

enum Inner {
    V10(crate::firmware::v10::operation::ClearOp),
    V11(crate::firmware::v11::operation::ClearOp),
    V12(crate::firmware::v12::operation::ClearOp),
}
