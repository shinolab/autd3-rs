...
impl From<autd3_gain_holo::GSOption<Sphere>> for GsOption {
    fn from(value: autd3_gain_holo::GSOption<Sphere>) -> Self {
        Self {
...
impl FromMessage<GsOption> for autd3_gain_holo::GSOption<Sphere> {
    fn from_msg(msg: GsOption) -> Result<Self, AUTDProtoBufError> {
        let default = autd3_gain_holo::GSOption::<Sphere>::default();
        Ok(Self {
            repeat: msg
                .repeat
                .map(usize::try_from)
    ...
    >
{
    fn from_msg(msg: Gs) -> Result<Self, AUTDProtoBufError> {
        Ok(Self {
            ...
            option: autd3_gain_holo::GSOption::from_msg(
...
mod tests {
    ...
    fn test_holo_gs() {
        ...
        let option = autd3_gain_holo::GSOption {
