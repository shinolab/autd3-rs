...
mod tests {
    ...
    fn make_random_v(backend: &NalgebraBackend, size: usize) -> Result<VectorX, HoloError> {
    ...
    fn make_random_cv(backend: &NalgebraBackend, size: usize) -> Result<VectorXc, HoloError> {
        let mut rng = rand::rng();
